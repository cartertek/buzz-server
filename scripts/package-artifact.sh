...
for file in install-package.sh install-release.sh buzz-serverctl provision-runtimes.sh prepare-community-identities.sh migrate-legacy-owner.py backup.sh restore.sh healthcheck.sh activation.py; do
