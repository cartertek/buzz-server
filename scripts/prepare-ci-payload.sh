...
install -m 0755 deploy/install-package.sh deploy/install-release.sh deploy/buzz-serverctl deploy/provision-runtimes.sh deploy/migrate-legacy-owner.py deploy/backup.sh deploy/restore.sh deploy/healthcheck.sh "$output_dir/deploy/"
